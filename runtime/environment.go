...
func (e *interpreterEnvironment) newOnFunctionInvocationHandler() func(_ *interpreter.Interpreter, _ ast.HasPosition, _ *interpreter.Invocation) {
	return func(_ *interpreter.Interpreter, _ ast.HasPosition, _ *interpreter.Invocation) {
